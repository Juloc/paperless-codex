...
RUN apt-get update \
    && apt-get install -y --no-install-recommends ca-certificates poppler-utils imagemagick tesseract-ocr tesseract-ocr-deu tesseract-ocr-eng \
...
COPY patch-pipeline22.mjs ./patch-pipeline22.mjs
COPY patch-pipeline23.mjs ./patch-pipeline23.mjs
COPY patch-pipeline24.mjs ./patch-pipeline24.mjs
...
ENV NODE_ENV=production \
    ...
    PAPERLESS_CODEX_PIPELINE_VERSION=24
